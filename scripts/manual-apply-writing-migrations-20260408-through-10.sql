-- One-shot manual apply: combines
--   20260408120000_writing_master_roles_reconciliation.sql
--   20260409120000_submission_attachments_metadata.sql
--   20260410120000_correction_annotations_sort_order.sql
--
-- Prerequisite: base writing schema (sessions, submissions, corrections, session_status enum, etc.)
