/**
 * Vercel `api/` バンドル専用 — 体験 Checkout 用 Stripe（server/ を参照しない）
 */
import Stripe from "stripe";

import { TRIAL_LESSON_AMOUNT_JPY } from "./trialLessonAmount";

export { TRIAL_LESSON_AMOUNT_JPY } from "./trialLessonAmount";
