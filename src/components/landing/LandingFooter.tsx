export default function LandingFooter() {
  const linkClass =
    "font-['Manrope'] text-[10px] md:text-xs tracking-widest uppercase text-[#1e1b13]/50 hover:text-[#1A237E] underline underline-offset-4 decoration-[#1A237E]/30 transition-all"
  ...
  return (
    <footer className="w-full py-12 md:py-16 px-6 md:px-8 bg-[#ECECEC] border-t border-[#1e1b13]/10">
      <div className="flex flex-col items-center gap-6 md:gap-8 max-w-7xl mx-auto text-center">
        <div>
          <div className="text-sm font-bold text-[#1b6d24] tracking-widest uppercase mb-1">作文トレーニング</div>
          <div className="text-lg md:text-xl font-bold text-[#1A237E] headline-font">ミリネ韓国語教室</div>
        </div>
