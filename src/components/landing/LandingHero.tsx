  ...
  return (
    <section className="pt-28 md:pt-32 pb-16 md:pb-20 px-6 md:px-8 max-w-7xl mx-auto overflow-hidden">
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div className="z-10">
          <span className="font-['Manrope'] text-[10px] md:text-xs tracking-[0.15em] text-[#000666] mb-4 md:mb-6 block font-bold">
            書く力を磨く、現代的なメソッド
          </span>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link
              to="/writing/intro"
              className="ink-gradient inline-flex items-center justify-center rounded-lg px-8 py-4 font-['Manrope'] text-xs font-bold tracking-wide text-white shadow-[0_12px_30px_rgba(0,6,102,0.24)] transition-all hover:opacity-90 md:px-10 md:py-5 md:text-sm"
            >
              コース詳細
            </Link>
            ...
            <Link
              ...
              className="inline-flex items-center justify-center border-b-2 border-[#000666]/20 text-[#000666] px-8 md:px-10 py-4 md:py-5 font-['Manrope'] font-bold tracking-wide text-xs md:text-sm hover:border-[#000666] transition-all"
            >
              体験レッスン
            </Link>
          </div>
        ...
        <div className="relative mt-4 lg:mt-0">
          ...
          <div className="absolute -bottom-4 md:-bottom-6 left-4 md:-left-6 bg-white px-4 py-3 md:p-6 rounded-xl shadow-[0_12px_40px_rgba(0,0,0,0.1)] border border-[#c6c5d4]/15 max-w-[180px] md:max-w-[240px]">
            <div className="flex items-center gap-2 md:gap-3 mb-2">
              ...
              <span className="text-[9px] md:text-[10px] font-bold tracking-wide opacity-60">ステータス</span>
            </div>
